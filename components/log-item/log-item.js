        ...
        this.shadowRoot.innerHTML =
            ...
            `       <link rel="stylesheet" href="./components/log-item/log-item-style.css">
                    ...
                    <div class="box">
                        ...
                        <div class="color-platte" title="Color">
    ...
    connectedCallback() {
        ...
        for(let item of [...skinBTN.children]){
            item.addEventListener('click', ()=>{
                ...
                if(item.dataset.skin === "blue-sun"){                    
                    this.particle.divMass.style.boxShadow = "0 0 50px blue";
                }

                if(item.dataset.skin === "pluto"){                    
                    this.particle.divMass.style.boxShadow = "0 0 20px white";
                }
            })
